            ...
            <div class="card mb-0">
                <div class="card-header">
                    <div class=" mx-3">
                        ...
                        <label class="mb-0"> Cadastre uma nova marca para relacionar ao seu produto.</label>
                    </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-8">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" name="nome" class="form-control" placeholder="Marca 1" required>
                                </div>
                                <div class="form-group col-12">
                                ...
                                <div class="form-group mb-0">
                                    <div class="text-center">
                                        ...
                                        <div id="PreviewImage" class="image-preview w-100" style="height: 300px;">
                                          <label for="id_imagem_marcas" id="image-label" class="text-white rounded">Selecione</label>
                                          <input type="file" accept="image/*" name="id_imagem" id="id_imagem_marcas" onchange="image(this);">
                                        </div>  
