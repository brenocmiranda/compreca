        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <form method="POST" action="{{ route('editando.clientes', $clientes->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-2 mx-auto">
                            <div class="col-3 border rounded-lg mx-1 text-center bg-white border-primary" id="variante1" style="cursor: pointer">
                                <div class="pt-3">
                                    <label class="colorinput mx-2">
                                        <input type="radio" name="tipo" value="pf" class="colorinput-input" {{($clientes->tipo == "pf" ? 'checked' : '')}}>
                            ...
                            <div class="col-3 border rounded-lg mx-1 text-center bg-white" id="variante2" style="cursor: pointer">
                                <div class="pt-3">
                                    <label class="colorinput mx-2">
                                        <input type="radio" name="tipo" value="pj" class="colorinput-input" {{($clientes->tipo == "pj" ? 'checked' : '')}}>
                                        <span class="colorinput-color bg-light border rounded-circle"></span>
                                    </label>
                            ...
                            <div class="card-body">
                                <div class="form-group col-12">
                                    <label class="custom-switch px-0">
                                        <input type="checkbox" name="status" class="custom-switch-input" {{($clientes->status == 1 ? 'checked' : '')}}>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" name="nome" class="form-control" onkeyup="this.value = this.value.toUpperCase();" placeholder="Cliente 1" value="{{$clientes->nome}}" required>
                                </div>
                                <div class="form-group col-4">
                                    <label><span id="nome">Apelido</span> <i class="text-danger">*</i></label>
                                    <input type="text" name="apelido" class="form-control" onkeyup="this.value = this.value.toUpperCase();" placeholder="Cliente" value="{{$clientes->apelido}}" required>
                                </div>
                                <div class="form-group col-6">
                                    <label>Email <i class="text-danger">*</i></label>
                                    <input type="email" name="email" class="form-control" placeholder="cliente@compreca.com.br" value="{{$clientes->email}}" required>
                                </div>
                                <div class="d-flex col-8 p-0">
                                    <div class="form-group col-6">
                                        <label><span id="nomeDocumento">CPF</span> <i class="text-danger">*</i></label>
                                        <input type="text" name="documento" class="documento form-control" value="{{$clientes->documento}}" required>
                                    </div>
                                    <div class="form-group col-6">
                                        <label>Telefone ou Celular <i class="text-danger">*</i></label>
                                        <input type="text" name="telefone" class="telefone form-control" placeholder="(00) 00000-0000" value="{{(isset($clientes->RelationTelefones) ? str_replace('55', '', $clientes->RelationTelefones->tel_contato) : '')}}" required>
                                    </div>
                                </div>
                                <div class="d-flex col-12 p-0">
                                    <div class="form-group col-4">
                                        <label>Data de nascimento</label>
                                        <input type="date" name="data_nascimento" class="form-control" placeholder="__ / __ / ____" value="{{$clientes->data_nascimento}}">
                                    </div> 
                                    <div class="form-group col-3">
                                        <label class="mb-0">Sexo <i class="text-danger">*</i></label>
                                        <select name="sexo" required>
                                            <option disabled> Selecione </option>
                                            <option value="M" {{($clientes->sexo == "M" ? 'checked' : '')}}> Masculino </option>
                                            <option value="F" {{($clientes->sexo == "F" ? 'checked' : '')}}> Feminino </option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="card" id="card-{{$key+2}}">
                                        <div class="card-header py-0">
                                            <h5 class="section-title d-flex my-2 align-items-center">
                                                <input type="text" name="nomeEndereco[]" class="border-0 mb-0" placeholder="Nome do seu endereço" value="{{$endereco->nome}}" style="font-size: 18px">
                                            </h5>
