...
<div class="main-content">
    <section class="section p-0">
        <div class="section-header">
            <div class="mx-3">
                <h1>Clientes</h1>  
                <label class="px-2 mb-0">{{$clientes}} clientes</label>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="d-flex ml-auto col-2 mt-3 button-edit"> 
                            <div class="">
                                <a href="{{ route('adicionar.clientes') }}" class="d-flex my-auto btn waves-effect waves-light"><i class="mdi mdi-plus"></i><b class="px-1"> Novo cliente</b></a>
                            </div>
                        </div>
                        @endif
...
<script type="text/javascript">
    ...
    function resetarSenha(id){
        swal({
          title: "Tem certeza que deseja resetar a senha do cliente?",
          icon: "warning",
