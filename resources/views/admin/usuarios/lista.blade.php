                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="d-flex ml-auto col-2 mt-3 button-edit"> 
                            <div class="">
                                <a href="{{ route('adicionar.usuarios') }}" class="d-flex my-auto btn waves-effect waves-light"><i class="mdi mdi-plus"></i><b class="px-1"> Novo usuário</b></a>
                            </div>
                        </div>
                        @endif
