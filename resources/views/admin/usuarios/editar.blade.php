        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <form method="POST" action="{{ route('editando.usuarios', $usuarios->id) }}"  enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">                                
                                        ...
                                        <div class="col-8">
                                            <div class="form-group col-12">
                                                <label class="custom-switch px-0">
                                                    <input type="checkbox" name="status" class="custom-switch-input" {{ ($usuarios->status == 1 ? 'checked' : '') }}>
                                            ...
                                            <div class="form-group col-10">
                                                ...
                                                <input type="text" name="nome" class="form-control" placeholder="Usuário 1" value="{{$usuarios->nome}}" required>
                                            </div>
                                            ...
                                            <div class="form-group col-8">
                                                ...
                                                <input type="email" name="email" class="form-control" placeholder="suporte@compreca.com.br" value="{{$usuarios->email}}" required>
                                            </div>
                                            <div class="form-group col-10">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="col-8 p-0">
                                                        <select class="id_loja" name="id_loja" id="listaLojas" {{(Auth::guard('admin')->user()->id_grupo == 1 ? 'required' : 'disabled') }}>
                                                            ...
                                                            <option value="{{$loja->id}}" {{ ($usuarios->id_loja == $loja->id ? 'selected' : '') }}>{{$loja->nome}}</option>
                                                            @endforeach
                                                        </select>
                                                        <small>
                                                    ...
                                                    <div class="col-7 p-0">
                                                        <select class="id_grupo" name="id_grupo" id="listaGrupos" required>
                                                            ...
                                                            @foreach($grupos as $grupo)
                                                                <option value="{{$grupo->id}}" {{ ($usuarios->id_grupo == $grupo->id ? 'selected' : '') }}>{{$grupo->nome}}</option>
                                                            @endforeach
                                                        </select>
                                                        <small>
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-12">
                                                        <div class="border p-3 col-9 rounded-circle text-center mx-auto">
                                                            <img class="w-100 rounded-circle" id="PreviewImage" src="{{ (isset($usuarios->RelationImagens) ? asset('storage/app/'.$usuarios->RelationImagens->caminho.'?'.rand()) : asset('public/admin/img/user.png').'?'.rand()) }}" style="height: 190px;" >
