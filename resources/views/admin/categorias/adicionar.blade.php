        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <form method="POST" action="{{ route('salvar.categorias') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="card-body d-flex">
                                <div class="col-8">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" name="nome" class="form-control" placeholder="Digite aqui o nome da categoria" required>
                                    </div>
                                    <div class="form-group col-12">
