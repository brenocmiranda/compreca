        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <form method="POST" action="{{ route('editando.categorias', $categoria->id) }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-8">
                                    <div class="form-group col-12">
                                        <label class="custom-switch px-0">
                                            <input type="checkbox" name="status" class="custom-switch-input" {{( $categoria->status == 1 ? ' checked' : '')}}>
                                ...
                                <div class="col-4">
                                    <div class="form-group mb-0">
                                        <div class="text-center">
                                            ...
                                            <div id="PreviewImage" class="image-preview w-100" style="height: 300px; background: url('{{ ( isset($categoria->RelationImagens->caminho) ? asset('storage/app').'/'.$categoria->RelationImagens->caminho.'?'.rand() : '') }}') no-repeat; background-size: contain; background-position: center;">
                      ...
                      <div class="col-12 mb-5 text-right">
                        <a href="javascript:history.back()" class="btn btn-secondary col-2 mx-1">Cancelar</a>
