        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <form method="POST" action="{{ route('editando.variacoes', $variacao->id) }}" >
                        @csrf
                            ...
                            <div class="card-body">
                                <div class="form-group col-12">
                                    <label class="custom-switch px-0">
                                        <input type="checkbox" name="status" class="custom-switch-input" {{($variacao->status == 1 ? 'checked' : '')}}>
                                ...
                                <div class="form-group col-8">
                                    ...
                                    <input type="text" name="nome" class="form-control" placeholder=" Ex.: Tamanho M" value="{{$variacao->nome}}" required>
                                </div>
                                <div class="form-group col-12">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="col-4 p-0">
                                            <select class="id_opcao" name="id_opcao">
                                                ...
                                                <option value="{{$opcao->id}}" {{ ($variacao->id_opcao == $opcao->id ? 'selected' : '') }}>{{$opcao->nome}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div>
                                            <a class="btn waves-effect waves-light text-white mx-3" data-toggle="modal" data-target="#variacao-opcao"> <i class="mdi mdi-plus"></i> Cadastrar opção</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-3">
                                    <label>Valor <i class="text-danger">*</i></label>
                                    <input type="text" name="valor" class="form-control" placeholder=" Ex.: PP, P, M, G, GG" value="{{$variacao->valor}}" required>
                                </div>
                            </div>
                        </div>
