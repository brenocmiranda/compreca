        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    ...
                    <form method="POST" action="{{ route('editando.leads', $leads->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card" id="card-1">
                            ...
                            <div class="card-body">
                                <div class="form-group col-7">
                                    ...
                                    <input type="text" name="nome" class="form-control" placeholder="Digite aqui o nome" onkeyup="this.value = this.value.toUpperCase();" value="{{$leads->nome}}" required>
                                </div>
                                <div class="form-group col-6">
                                    <label>E-mail <i class="text-danger">*</i></label>
                                    <input type="email" name="email" class="form-control" placeholder="Entre com o email" value="{{$leads->email}}"  required>
                                </div>
                                <div class="form-group col-3">
                                    <label>Telefone</label>
                                    <input type="text" name="tel_contato" class="telefone form-control" value="{{$leads->tel_contato}}" placeholder="(00) 00000-0000">
                                </div>
                            </div>
                        </div>
