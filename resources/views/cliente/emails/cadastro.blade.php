		...
		<tr>
			<td align="center">
				<table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
					<tr style="background: #9e9e9e4a">
						<td class="header" align="center">
							<a href="{{ config('app.url') }}">
								<img src="<x-logomarca/>" alt="Imagem logo" height="40" style="padding: 20px;">
							</a>
						</td>
					</tr>
							...
							<table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
								...
								<tr>
									<td class="content-cell">
										...
										<p> É muito bom te ter conosco =)</p>
										<p> Você está a um passo de confirmar seu cadastro na nossa plataforma e para fazer isso você precisa acessar o link abaixo… vamos lá:</p>
										<a href="{{route('ativarCadastro.mkt', $usuario->_token)}}"> Clique aqui e confirme seus dados.</a>
										<p>
											<span>Um grande abraço!</span>
											<br>
											<span>#TodosJuntosNoComercioLocal</span>
										</p>
									</td>
								</tr>
							</table>
							...
							<table class="footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
								<tr>
									<td class="content-cell" align="left">
										<hr>
										<br>
										<b>Equipe de suporte do CompreCá!</b><br>
